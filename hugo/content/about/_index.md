![Photo of my face](pfertyk.jpg#profile-photo)
...
I'm a Polish software developer, presently living in Belgium.
I'm a huge fan of Linux, open source,
...
I dabble in game development as well: as [Miskatonic Studio](https://miskatonicstudio.com) I've released [Intrepid](https://store.steampowered.com/app/992860/Intrepid), [Arboretum](https://miskatonicstudio.itch.io/arboretum), [Hexpanse](https://hexpanse.miskatonicstudio.com/), and a few [other projects](https://github.com/miskatonicstudio).
</p>
...
* [**Odoo**](https://github.com/odoo/odoo) suite of web based open source business apps
...
* [**Godot Experiments**](https://github.com/miskatonicstudio/godot-experiments) collection of simple Godot Engine projects, mostly shaders
* [**Godot Array Modifier**](https://github.com/miskatonicstudio/godot-array-modifier) plugin for procedural duplication of Godot nodes
* [**Intrepid**](https://github.com/miskatonicstudio/intrepid) adventure game, full source code and assets
* [**WebRTC example**](https://github.com/pfertyk/webrtc-working-example) simple web and mobile demo of WebRTC
* [**Terraform Templates**](https://github.com/pfertyk/terraform-templates) collection of ready-to-use Terraform solutions
...
* **Manage your Logistics Operations with RPC** ([video](https://www.youtube.com/watch?v=r1vyqfDPK4k))
* **The journey to Godot 4: what can you expect?** ([video](https://www.youtube.com/watch?v=a28R9cORsLQ), [slides](https://github.com/miskatonicstudio/godotcon-slides/tree/main/2023))
* **Shader shenanigans** ([video](https://www.youtube.com/watch?v=VoTGkcxONdw), [source code](https://github.com/miskatonicstudio/godotcon-2021))
* **Making 3D adventure games with Godot** ([video](https://youtu.be/tHTz848VBcs?t=73))
* **The good, the bad, and the ugly: 3D features of Godot** ([video](https://www.youtube.com/watch?v=QX5RIeiJ3Qs))
* **Introduction to aiohttp** ([slides](https://github.com/pfertyk/aiohttp))
* **Clean code in tests** ([video](https://www.youtube.com/watch?v=SFDqVP7iP6k&index=8&list=PLwXxS6lAcQUNMUGloNZmlB1dbE95XhQDs), [slides](https://github.com/pfertyk/clean-tests))
* **Pygame workshop for PyLadies Poznań** ([slides](https://github.com/pfertyk/pygame-workshop), [source code](https://github.com/pfertyk/workshop-pyladies-pygame))
